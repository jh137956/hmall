					...
					<div class="row">
						<div class="col-lg-12">
							<div class="panel panel-default">
								...
								<div class="panel-footer" id="replyPaging"></div>
							</div>
						</div>
					</div>

				</div>
				<div class="modal fade" id="replyModal" data-backdrop="static"
					data-keyboard="false" tabindex="-1"
					aria-labelledby="exampleModalLabel" aria-hidden="true">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title" id="modalLabel">Reply Register
									Modal</h5>
							...
							<div class="modal-body">
								<div class="form-group">
									<label>Reply</label> <input type="hidden" class="form-control"
										name="replyRno" id="replyRno"> <input
										class="form-control" name="reply" id="reply">
								</div>
								<div class="form-group">
									<label>Replyer</label> <input class="form-control" name="mb_id"
										id="mb_id">
								</div>
							</div>
							<div class="modal-footer">
								...
								<button type="button" id="btnReplyAdd"
									class="btn btn-primary btnModal">Save Add</button>
								<button type="button" id="btnReplyEdit"
									class="btn btn-primary btnModal">Save Edit</button>
								<button type="button" id="btnReplyDel"
									class="btn btn-primary btnModal">Reply Del</button>
							</div>
						</div>
					</div>
				</div>
