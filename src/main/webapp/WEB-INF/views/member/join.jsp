...
<div class="wrapper">
  <div class="wrap">
	...
	<div class="content">
		<div class="container">
			<div class="membership" style="width: 70%; margin: 0 auto; margin-top: 20px;">
				<div class="container"
						...
						<div class="container" style="width: 800px;">
							...
							* 아래 항목을 작성해주세요.<br>
							...
							<div class="form-group" style="width: 100%;">
								...
								<button id="btn_check" class="btn btn-default" type="button">중복확인</button>
							...
							<div class="form-group">
								...
								<label><input type="radio" name="mb_sex" value="M"
									style="margin-left: 20px;" checked="checked"> 남</label> 
								<label><input type="radio" name="mb_sex" value="W"
									style="margin-left: 20px;"> 여</label>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<input type="text" id="sample2_postcode"
									...
									class="form-control" name="mb_post" placeholder="우편번호" readonly> 
