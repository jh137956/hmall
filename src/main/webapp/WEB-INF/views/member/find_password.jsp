						...
						<div id="login-row"
							...
							<div id="login-column" class="col-md-6">
								<div id="login-box" class="col-md-12" style="margin-top: 20px;">
									<form id="find_password" class="form login-box" action="" method="post">
										<h3 class="text-center text-info">비밀번호 찾기</h3>
										<div class="form-group">
											<label for="mb_id" class="text-info">id:</label><br> 
											<input type="text" name="mb_id" id="mb_id" class="form-control">
										</div>
										<div class="form-group">
											<label for="mb_name" class="text-info">name:</label><br>
											<input type="email" name="mb_name" id="mb_name" class="form-control">
										</div>
										<div class="btn-passwordSearch">
											<input type="button" name="btn-passwordSearch" id="btn-passwordSearch" class="btn btn-info btn-md align" value="find">
