	...
	<div>
    	...
    	<div style="width: 60%; margin: 0 auto;">
    		<div class="panel panel-default">
    			<form role="form" method="post" action="/admin/board/adinsert">
					...
					<div class="form-group" style="width: 95%; margin:0 auto;">
						...
						<textarea  name="b_content" class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
					</div>
					<div class="form-group" style="width: 95%; margin:0 auto;">
						...
						value="<c:out value="${vo.admin_id}" />" readonly>
					</div>
