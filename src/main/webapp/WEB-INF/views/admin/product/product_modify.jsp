					...
					<form id='modifyForm' role="form" action="/admin/product/modify" method="post" enctype="multipart/form-data">
						<div class="box-body">
							<div class="form-group">
								...
								<select class="form-control" id="mainCategory" name=cg_prt_code style="width:30%; margin-right:10px; display: inline-block;" >
								  <option value="default">1차 카테고리 선택</option>					  
								  <c:forEach items="${categoryList }" var="cate">
								  	<option value='<c:out value="${cate.cg_code }" />' <c:out value="${cate.cg_code == productVO.cg_prt_code ? 'selected' : ''}" />>
							...
							<div class="form-group">
								...
								<input type="text" id="pdt_company" name="pdt_company" value='<c:out value="${productVO.pdt_company}" />' class="form-control"
							...
							<div class="form-group">
								...
								<input style="width:40%; margin-right:10px; display: inline-block;"
									type="text" id="pdt_price" name="pdt_price" class="form-control" value='<c:out value="${productVO.pdt_price}" />'
									placeholder="Enter price" />
								<input style="width:40%; display: inline-block;"
									type="text" id="pdt_discount" name="pdt_discount" class="form-control " value='<c:out value="${productVO.pdt_discount}" />'
							...
							<div class="form-group">
								...
								<input style="width:30%; margin-right:10px; display: inline-block;"
									type="text" id="pdt_count_buy" name='pdt_count_buy' value='<c:out value="${productVO.pdt_count_buy}" />' class="form-control" 
